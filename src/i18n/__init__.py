...
_EMBEDDED_EN: dict[str, str] = {
    ...
    "reject": "Reject",
    "add_entry": "Add Entry",
    "entry_source": "Source term",
    "entry_target": "Target term",
    "delete": "Delete",
    "label_backend": "AI Backend / Provider",
    "label_model_identifier": "Model Identifier",
    "prompt_saved": "Prompt saved for this style.",
}
...
_EMBEDDED_ZH_HK: dict[str, str] = {
    ...
    "entry_target": "\u8b6f\u6587\u8853\u8a9e",
    "delete": "\u522a\u9664",
    "label_backend": "AI \u5f8c\u7aef / \u63d0\u4f9b\u8005",
    "label_model_identifier": "\u6a21\u578b\u8b58\u5225\u78bc",
    "prompt_saved": "\u6b64\u98a8\u683c\u7684\u63d0\u793a\u8a5e\u5df2\u5132\u5b58\u3002",
}
